...
void EntityIntersect(const std::set<int>& set1, const std::set<int>& set2, std::set<int>& out)
{
	out.clear();
...
void EntityExcept(const std::set<int>& set1, const std::set<int>& set2, std::set<int>& out)
{
	out.clear();
	std::set<int>::const_iterator itr1 = set1.begin();
	for (; itr1 != set1.end(); ++itr1)
